...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(packTasks, 'packTasks', 'src/gulp-tasks-pack.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/gulp-tasks-pack.js');
}();
