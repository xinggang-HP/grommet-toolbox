...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(syncTasks, 'syncTasks', 'src/gulp-tasks-sync.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/gulp-tasks-sync.js');
}();
